/**
 * The Tasks explainer, in either shape.
 *
 * One component for both, unlike the flagship spot: every beat here is words
 * plus one animated widget, so the whole difference between 16:9 and 9:16 lives
 * inside `<Beat>` and the scenes only have to say how big the widget is.
 */
