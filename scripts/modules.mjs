...
const ABOUT = {
  ...
  'registry': ['The 44 entities: fields, merge rules, visibility, and what the client mirrors.'],
  ...
  'mcp': ['The tool surface an assistant talks to: 81 tools and 5 prompts.'],
  ...
  'kernel/mail': ['What an address is, and how a URL spells a relay or a mailbox. No sockets.'],
  'adapter/mail': ['Batching, the queue, SMTP by hand, and knowing an address from a bounce.'],
  'capability/mail': ['Connected inboxes: who may read one, one search across all of them, the numbers, and the credential.', 'mail'],
  'imap': ['Reading a mailbox by hand: the grammar, the conversation, and MIME.'],
  'oauth': ['Single sign-on in, an authorisation server out, and a token for somebody else\'s mailbox.'],
