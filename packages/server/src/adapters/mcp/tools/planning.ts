...
import { instantiateTemplate } from '../../../modules/automation/automation.ts';
import { canSeeProject, deleteEntity, visibleProjectIds, writeEntity } from '../../../kernel/write-path/repo.ts';
