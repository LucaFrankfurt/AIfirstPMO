 ...
 */
const ProjectKpis = lazy(() => import('../../kpis/routes/kpis').then((m) => ({ default: m.ProjectKpis })));
const MilestoneKpis = lazy(() => import('../../kpis/routes/kpis').then((m) => ({ default: m.MilestoneKpis })));
/**
...
import { byOrder, create, createPage, remove, update } from '../../../kernel/sync/mutations';
...
import { useCanWrite, useFeature, useMe, useMembers, useSession } from '../../../kernel/identity/session';
import { groupKey, roleKey, useT, type TranslationKey } from '../../../kernel/i18n/i18n';
import { ProjectFields } from '../../work/fields';
import { CopyProjectSheet } from '../copy-project';
import { configOf, useProjectDefaultView } from '../../work/saved-views';
